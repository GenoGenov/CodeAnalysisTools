...
namespace CodeAnalysisTools.CodeFixes
{
	...
	public class ClosingBracePrecededByBlankLineCodeFixProvider : CodeFixProvider
	{
		...
		private async Task<Document> RemoveLeadingBlankLineAsync(Document document, SyntaxToken token, CancellationToken cancellationToken)
		{
			var newNode = token.RemovePreceedingBlankLine();
